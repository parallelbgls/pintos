...
/* Removes the lock for current thread. */
void
...
/* Increases recent_cpu by 1 per thread tick. */
void
...
/* Updates priority for BSD scheduler priority updater. */
void
...
/* Refreshes load_avg and recent_cpu for all threads per second. */
void
